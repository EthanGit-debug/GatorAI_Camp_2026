...
SCREEN_WIDTH = 1900  # Width of game window in pixels (Default: 1280)
SCREEN_HEIGHT = 950  # Height of game window in pixels (Default: 720)
...
PLAYER_NAME = "Ethan"  # Name shown for the player (Default: "Farmer")
GREETING = "fahhhhhh!"  # Starter greeting text (Default: "Hello there!")
...
SALE_PRICES = {
    "wood": 50,  # Default sale value for wood
    "apple": 50,  # Default sale value for apples
    "corn": 50,  # Default sale value for corn
    "tomato": 50,  # Default sale value for tomatoes
}

# How much it costs to buy each seed
PURCHASE_PRICES = {
    "corn": 3,  # Default seed purchase price for corn
    "tomato": 4,  # Default seed purchase price for tomatoes
}
